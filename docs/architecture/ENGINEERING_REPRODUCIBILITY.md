...
v0.2.5ではRecent Event Buffer容量、Incremental Statisticsの表示sampling、Historical Milestone表示、Optional Raw Archiveの有無・flush・圧縮も非権威的である。同じCode / Config / RunSeedでEvent列と最終stateを変えてはならない。
