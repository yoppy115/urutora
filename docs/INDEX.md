...
| [`V0_15_ECOLOGY.md`](design/V0_15_ECOLOGY.md) | Baseline / v0.15 configurable | Targeted Action、短寿命Vitality、情報容量、HP/Damage再scale |
...
- [`IMPLEMENTATION_REGISTER.md`](IMPLEMENTATION_REGISTER.md): 正史へ混ぜない実装要望・技術的既定値の追跡台帳。ゲーム仕様の正本ではない。
