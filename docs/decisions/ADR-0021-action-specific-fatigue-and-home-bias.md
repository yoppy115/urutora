...
v0.2.4はAction種類別の身体疲労、閾値付き対数RestPressure、自Settlement内Move疲労軽減、Weak / Strong Home Bias、平時Foreign avoidanceを採用する。Biasは通常Move候補weightであり、Flee、Advance、Defenseを上書きしない。ReactionはAction枠や通常Activity効果を得ないが、身体的なCounterattack / Pursuit疲労は受ける。
