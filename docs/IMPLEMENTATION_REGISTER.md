...
| v0.2 Config schema | Implemented | `V0_2_SETTLEMENT_ORDER.md`, `simulation/configs/v0-default.json` | schema 2 / `v0.2-default-1`。Settlement、Invasion、Auraの全調整値をstrict JSONへ分離 |
...
| v0.2 log schema | Implementation detail | `LOGGING.md`, `STATISTICS.md` | `run.json` schema 5、Event wrapper 3、diagnostics 4。既存release別World連番・圧縮・SHA-256を維持 |
