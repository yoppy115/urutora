...
- `configs/`: v0.2.1 default。人口、Need、Utility、行動、戦闘、繁殖、Vitality、Settlement、Order、Invasion、Aura等。
...
## v0.2.1 adopted defaults

v0.15値とv0.2の社会境界は明示変更箇所以外を維持し、次をv0.2.1 Configとして使う。
...
`configs/v0-default.json` はschema version 2、ID `v0.2.1-default-1`。観測Appは各Worldへ完全Config snapshotと次の再現情報を保存する。

```json
{
  "schemaVersion": 5,
  "seed": 8147291,
  "configId": "v0.2.1-default-1",
