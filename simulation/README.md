...
- `configs/`: v0.2.5 default。人口、Need、Utility、行動、戦闘、繁殖、Vitality、Knowledge、Settlement、Fission、Invasion、Event保持、決定論的実行設定等。
